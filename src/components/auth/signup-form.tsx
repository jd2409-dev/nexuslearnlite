...
const formSchema = z.object({
  ...
  board: z
    .string({ required_error: "Please select your board." })
    .min(1, { message: "Please select your board." }),
  gradeLevel: z
    .string({ required_error: "Please select your grade." })
    .min(1, { message: "Please select your grade." }),
});
